...
n = 100; %The size of decision variable x
m = 100; %The size of random vector \xi
...
record = zeros (500,13);% 1=ID 2=Support type  3=m1  4=case number 5= original Value  6=original CPU  7= LB Value 8= LB CPU  9= Relative gap  10= Relative Theoretical gap
...
for switch2 = 1 : 3
    ...
    for iterationNumber = 1 : Number
        ...
        for switch3 = 1 : 5
            ...
            [ Af_opt2,AX_opt2,ACPUTime2,ALanda1OPT,ALanda2OPT] = ArbitraryLBMomentNewsvendorPaper( ZIGMAtemp,mu,m1,A,b,gamma1,gamma2,switch1,c,v,g);
            record(ID,10) = Af_opt2;
            record(ID,11) = ACPUTime2;
            
            record(ID,12) = abs(((f_opt1 - Af_opt2)/ f_opt1) * 100); % Relative Gap
            
            TheoreticalGap = ArbitraryTheoGapMomentNewsvendor( ALanda1OPT,ALanda2OPT,ZIGMAtemp,m1,m,switch1,f_opt1,A,gamma2,v,g);% Relative Theoretical Gap
