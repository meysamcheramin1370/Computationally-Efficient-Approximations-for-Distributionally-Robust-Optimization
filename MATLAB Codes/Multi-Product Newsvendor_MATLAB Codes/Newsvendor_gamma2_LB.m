...
switch2 = 1; %gamma1 type (1= 0, 2 = 1, 3 = 2, 4 = 3, 5 = 4, 6 = 5)
...
gamma2_list = [1,2,3,4,5,6]; % The parameter of moment-based ambiguity set (Zhang's paper)

%%%%%%%%%%%%%%%%%%%%%% To solve general moment-based LB of CVaR %%%%%%%
Number = 5; % The number of randomly generated Original DRO problems for each case (We consider the avarage performance of all of them)

record = zeros (500,10);% 1=ID   2=Main problem number  3=gamma1 4 = m1 5= original Value  6=original CPU  7= LB Value 8= LB CPU  9= Relative gap  10= Relative Theoretical gap
