function [ UBTheoreticalGap ] = UBTheoGapMomentProduction( z_opt2,Landa1OPT,Landa2OPT,Landa3OPT,Landa4OPT,Landa5OPT,ZIGMAtemp,m1,size,switch1,f_opt2,A,gamma2,alpha_k)
%This function calculates the upper bound of the Relative theoretical upper bound of the GAP between
...
UBTheoreticalGap = abs((sqrt(gamma2)*(sqrt(summation1) + sqrt(summation2) + sqrt(summation3) + sqrt(summation4)+ sqrt(summation5)))/f_opt2)*100;
end
