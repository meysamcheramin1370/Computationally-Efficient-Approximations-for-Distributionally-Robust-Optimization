...
record = zeros (100,14);% 1=ID 2= original Value  3=original CPU  4= UB1 Value 5= UB1 CPU  6= UB1 Relative gap  7= UB2 Value   8= UB2 CPU  9= UB2 Relative gap 10= UB3 Value 11= UB3 CPU  12= UB3 Relative gap
...
for iterationNumber = 1 : Number
    ...
    for j=1:3
        for i=1:3
            ...
            record(ID,8) = abs(((f_opt2 - f_opt1 )/ f_opt1) * 100); % Relative Gap
            ...
            record(ID,9) = f_opt3;
            record(ID,10) = CPUTime3;
            record(ID,11) = abs(((f_opt3 - f_opt1 )/ f_opt1) * 100); % Relative Gap
            ...
            record(ID,12) = f_opt4;
            record(ID,13) = CPUTime4;
            record(ID,14) = abs(((f_opt4 - f_opt1 )/ f_opt1) * 100); % Relative Gap
