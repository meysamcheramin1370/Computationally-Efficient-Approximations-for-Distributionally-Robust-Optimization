...
m=5; % The number of suppliers
n=20; % The number of customers
...
Number = 1; % The number of randomly generated test problems for each case (We consider the avarage performance of all of them)

record = zeros (500,13);% 1=ID 2=Support type  3=m1   4= original Value  5=original CPU  6= LB Value 7= LB CPU  8= Relative gap  9= Relative Theoretical gap
...
for switch2 = 1 : 3
    ...
    for iterationNumber = 1 : Number
        ...
        for switch3 = 1 : 5
            ...
            TheoreticalGap = TheoGapMomentProduction( z_opt2,Landa1Opt,Landa2Opt,Landa3Opt,Landa4Opt,Landa5Opt,ZIGMAtemp,m1,size,switch1,f_opt1,A,gamma2,alpha_k);
            record(ID,9) = TheoreticalGap;   
            
            [ Af_opt2,AX_opt2,Az_opt2,ACPUTime2,ALanda1Opt,ALanda2Opt,ALanda3Opt,ALanda4Opt,ALanda5Opt ] = ArbitraryLBMomentProduction( ZIGMAtemp,mu,m1,A,b,gamma1,gamma2,switch1,c,d,alpha_k,beta_k,m,n);
            record(ID,10) = Af_opt2;
            record(ID,11) = ACPUTime2;
            
            record(ID,12) = abs(((f_opt1 - Af_opt2)/ f_opt1) * 100); % Relative Gap
        
            TheoreticalGap = ArbitraryTheoGapMomentProduction( Az_opt2,ALanda1Opt,ALanda2Opt,ALanda3Opt,ALanda4Opt,ALanda5Opt,ZIGMAtemp,m1,size,switch1,f_opt1,A,gamma2,alpha_k);
            record(ID,13) = TheoreticalGap;  
