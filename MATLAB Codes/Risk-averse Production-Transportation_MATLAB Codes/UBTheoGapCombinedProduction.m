function [ TheoreticalGap ] = UBTheoGapCombinedProduction(z_opt2,zetaOpt,N,ZIGMAtemp,m1,size,switch1,f_opt2,gamma2,alpha_k)
...
TheoreticalGap = abs(sqrt(gamma2/N)*(summation/f_opt2))*100;
