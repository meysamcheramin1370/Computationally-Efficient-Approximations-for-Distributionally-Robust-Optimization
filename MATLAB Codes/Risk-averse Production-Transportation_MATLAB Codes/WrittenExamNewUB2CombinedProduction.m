function [ f_opt,X_opt,z_opt,CPUTime] = WrittenExamNewUB2CombinedProduction( ZIGMAtemp,mu,m1,N,switch1,R0,gamma1,gamma2,cosiPrime,c,d,alpha_k,beta_k,m,n)
...
variables q(size) zeta(size,N) y(N) s11(N) s21(N) s12(N) s22(N) s13(N) s23(N) s14(N) s24(N) s15(N) s25(N);
