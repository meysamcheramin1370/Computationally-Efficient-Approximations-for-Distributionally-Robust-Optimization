function [ A1Complete,A1,A2,A3,ZIGMA,U,delta ] = New2covTransformerDecomposer(ZIGMAtemp,m,m1,m2,m3,switch1)
% (this function is used for the 3-partiton upper bound).  With the randomly generated covariance matrix \Sigma, we replace its ith
...
A3 = Vs(:,m1 + m2 + 1:m1 + m2 + m3)*H(m1 + m2 + 1:m1 + m2 + m3,m1 + m2 + 1:m1 + m2 + m3).^(1/2); % This matrix is used only for 2-partition Upper Bound problem
