function [ A1Complete,A1,A2,ZIGMA,U,delta ] = New1covTransformerDecomposer(ZIGMAtemp,m,m1,m2,switch1)
% (this function is used for the 2-partiton upper bound).  With the randomly generated covariance matrix \Sigma, we replace its ith
